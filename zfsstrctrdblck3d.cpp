...
void ZFSStrctrdBlck3D::computeZonalConnections() {   //junoh
  if(domainId()==0){
  ...
  // if(m_inputBlockId==0) {
  //   // cout << "I'm in block 0 and my domainId is:" << domainId() << endl;
  //   for(ZFSId cellId=0; cellId<m_noStrctrdCells; cellId++) {
  //     for(ZFSId var=0; var<PV->noVariables; var++){
  // 	m_cells->pvariables[var][cellId] = 2.0;
  //     }
  //   }
  // }

  // if(m_inputBlockId==1) {
  //   // cout << "I'm in block 1 and my domainId is: " << domainId() << endl;
    
  //   for(ZFSId cellId=0; cellId<m_noStrctrdCells; cellId++) {
  //     for(ZFSId var=0; var<PV->noVariables; var++){
  // 	m_cells->pvariables[var][cellId] = 3.0;
  //     }
  //   }
  // }
  
  // if(m_inputBlockId==2) {
  //   // cout << "I'm in block 2 and my domainId is: " << domainId() << endl;
  //   for(ZFSId cellId=0; cellId<m_noStrctrdCells; cellId++) {
  //     for(ZFSId var=0; var<PV->noVariables; var++){
  // 	m_cells->pvariables[var][cellId] = 4.0;
  //     }
  //   }
  // }
...
{ 
  ...
  for(ZFSId id=0; id<(ZFSInt)m_windowInfo->m_zonalBCMaps.size(); id++){
    ...
    // zfsTerm(1, __CALLING_FUNCTION__, "Leaving program at end of zonalGather!");
}
...
void ZFSStrctrdBlck3D::zonalSend()     //junoh
{
  for(ZFSId id=0; id<(ZFSInt)m_windowInfo->m_zonalBCMaps.size(); id++){
    ...
    // zfsTerm(1, __CALLING_FUNCTION__, "Leaving program at end of zonalSend!");
  }
}
...
void ZFSStrctrdBlck3D::zonalReceive() //junoh
{
  ...
  // zfsTerm(1, __CALLING_FUNCTION__, "Leaving program at end of zonalReceive!");
}
...
void ZFSStrctrdBlck3D::zonalScatter()
{
  ...
  // zfsTerm(1, __CALLING_FUNCTION__, "Leaving program at end of zonalScatter!");
  // saveOutputPartitions<true>();
  // zfsTerm(1, __CALLING_FUNCTION__, "Leaving program at end of zonalScatter!");
}
